...
class HealthMetricsTest {
  ...
  @CsvSource(
      ...
      value = {
          ...
          "application_health_check{check=\"context\",status=\"UP\"} 1.0",
          ...
          "application_health_check{check=\"context\",status=\"DOWN\"} 0.0",
      })
  // @formatter:on
  ...
  @CsvSource(
      ...
      value = {
          ...
          "application_health_check{check=\"context\",status=\"UP\"} 0.0",
          ...
          "application_health_check{check=\"context\",status=\"DOWN\"} 1.0",
      })
  // @formatter:on
